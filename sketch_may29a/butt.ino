...

{
...

  {
    ...
    case Button_Right:
      ...
      if (digitalRead(Right) == HIGH)                                                return ST_PRESSED;
    ...
    case Button_Up:
      ...
      if (digitalRead(Up) == HIGH)                return ST_PRESSED;
    ...
    case Button_Down:
      ...
      if (digitalRead(Down) == HIGH)                return ST_PRESSED;
    ...
    case Button_Left:
      ...
      if (digitalRead(Left) == HIGH)        return ST_PRESSED;
    ...
    case Button_Select:
      ...
      if (digitalRead(Enter) == HIGH)        return ST_PRESSED;
